...
This page walks you through running the Multica **server** (backend + frontend + PostgreSQL) on your own machine or server with Docker. When you're done, your data is fully under your control — including [workspaces](/workspaces), [tasks](/issues), [comments](/comments), and [digital employee](/agents) configuration.
...
## 6. Create a digital employee + assign your first task

Same flow as Cloud — see [Cloud quickstart → Steps 5-6](/cloud-quickstart#5-create-a-digital-employee).
...
- [GitHub integration](/github-integration) — connect a GitHub App so PRs auto-link to tasks and merging closes them
