...
<Callout type="info">
Digital employee visibility comes in two flavors: "workspace" and "private." Private digital employees can only be assigned to tasks by owners and admins — this protects configurations meant for a specific set of people. See [Digital employees](/agents).
</Callout>
...
Owners and admins can remove other members from a workspace. A removed member loses access immediately; tasks, comments, and other content they created are retained in the workspace.

## Next

- [Tasks and projects](/issues) — what members work on
